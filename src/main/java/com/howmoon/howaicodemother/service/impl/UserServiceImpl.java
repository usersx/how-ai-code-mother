...
import com.howmoon.howaicodemother.model.dto.user.UserQueryRequest;
import com.howmoon.howaicodemother.model.enums.UserRoleEnum;
...
import com.howmoon.howaicodemother.mapper.UserMapper;
...
import static com.howmoon.howaicodemother.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>  implements UserService{
    ...
    public String getEncryptPassword(String userPassword) {
        //盐值，混淆密码
        final String salt = "howmoon";
        return DigestUtils.md5DigestAsHex((salt + userPassword + salt).getBytes(StandardCharsets.UTF_8));
    }
